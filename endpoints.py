...
con_string="mongodb+srv://Sureka:surekaJerry@cluster0.jyhlsg2.mongodb.net/?retryWrites=true&w=majority"
client=pymongo.MongoClient(con_string)
db=client.get_database('test_db')
user_collection=pymongo.collection.Collection(db,'testcollection')
